...
export default {
  ...
  login: {
    ...
    captchaCooldown: 'Please wait before refreshing',
    ...
    passkeyLogging: 'Passkey Logging in...',
    passkeyNotSupported: 'Current browser does not support Passkey',
    passkeyChallengeFailed: 'Failed to create Passkey challenge',
    passkeyNotSelected: 'Passkey not selected',
    passkeyError: 'Passkey login failed',
    passkeyCancel: 'Passkey authentication was cancelled',
    passkeyTimeout: 'Passkey authentication timed out',
    deletePasskeyTitle: 'Delete Passkey',
    deletePasskeyConfirm:
      'Are you sure you want to delete "{name}"? You will no longer be able to log in using this Passkey.',
  },
  ...
  settings: {
    title: 'Preferences',
    subtitle: 'Customize theme, language, and interface preferences',
  ...
  notFound: {
    ...
    subtitle: 'The page is unavailable or has been removed.',
    pathLabel: 'Requested path',
    reasonTitle: 'Possible reasons',
    reason1: 'The page address is incorrect',
    reason2: 'The menu or module metadata has not finished loading',
    reason3: 'Your account does not have permission to access this page',
    reason4: 'The page configuration was removed by an administrator',
    back: 'Go Back',
    home: 'Back Home',
    footer: 'If you believe this is unexpected, contact ',

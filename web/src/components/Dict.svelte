      ...
      <div class="bg-white dark:bg-[#1d1d1d] rounded-lg shadow-sm">
        <div class="p-4 border-b border-gray-100 dark:border-gray-800">
          <input
            ...
            class="w-full h-9 px-3 text-sm border border-gray-200 dark:border-gray-700 rounded-lg bg-white dark:bg-[#141414] focus:outline-none focus:border-[color:var(--color-primary)]"
          />
        </div>
        <div class="divide-y divide-gray-100 dark:divide-gray-800">
          {#each filteredTypes as type}
            <Button.Root
              ...
              class="w-full px-4 {isCompact
                ? 'py-2'
                : 'py-3'} text-left hover:bg-gray-50 dark:hover:bg-[#262626] transition-colors {selectedType?.id ===
              type.id
                ? 'bg-[#409eff]/10 border-l-4 border-[color:var(--color-primary)]'
                : ''}"
            >
      ...
      {#if selectedType}
        <div class="bg-white dark:bg-[#1d1d1d] rounded-lg shadow-sm">
          ...
          >
            ...
            <Button.Root
              class="h-8 px-3 text-white text-sm rounded transition-colors flex items-center gap-1 hover:brightness-105 active:brightness-95"
                ...
                <tr class="bg-gray-50 dark:bg-[#262626]">
                  <th
                    class="px-4 {isCompact
                      ? 'py-2'
                      : 'py-3'} text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase"
                    >{$t('dict.label')}</th
                  >
                  <th
                    class="px-4 {isCompact
                  ...
                  <tr class="hover:bg-gray-50 dark:hover:bg-[#262626] transition-colors">
                    ...
                    <td class="px-4 py-3 text-sm">
                      <Button.Root
                        ...
                        style="color: var(--color-primary);">{$t('common.edit')}</Button.Root
                      >

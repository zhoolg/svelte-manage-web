...
<div class="min-h-[calc(100vh-200px)] flex items-center justify-center p-4">
  <div class="max-w-2xl w-full text-center">
    <!-- 404 大标题 -->
    <div class="mb-8">
      <h1 class="text-9xl font-bold mb-4 animate-pulse" style="color: var(--color-primary);">
        404
      </h1>
    ...
    <div class="bg-white dark:bg-[#1d1d1d] rounded-lg shadow-lg p-8 mb-6">
      ...
      <div class="flex flex-col sm:flex-row gap-3 justify-center">
        ...
        <button
          onclick={goHome}
          class="px-6 py-3 text-white rounded-lg transition-colors flex items-center justify-center gap-2 shadow-lg"
          style="background-color: var(--color-primary); box-shadow: 0 10px 30px color-mix(in srgb, var(--color-primary) 30%, transparent);"
        >
          <Home size={16} />

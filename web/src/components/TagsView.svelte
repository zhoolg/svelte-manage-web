    ...
    {#each tags as tag}
      ...
      <ContextMenu.Root onOpenChange={() => (contextMenuPath = tag.path)}>
        <ContextMenu.Trigger
          ...
          tag.path
            ? 'text-white border-[color:var(--color-primary)] bg-[color:var(--color-primary)]'
            : 'bg-white dark:bg-[#1d1d1d] text-[#495060] dark:text-[#ccc] border-[#e6e6e6] dark:border-[#303030] hover:border-[color:var(--color-primary)]'}"
        >
        ...
        <ContextMenu.Portal>
          ...
          >
            <ContextMenu.Item
              ...
              class="w-full flex items-center px-4 py-2 text-[13px] text-[#606266] dark:text-[#ccc] hover:bg-[#ecf5ff] hover:text-[color:var(--color-primary)] transition-colors cursor-pointer outline-none"
            >

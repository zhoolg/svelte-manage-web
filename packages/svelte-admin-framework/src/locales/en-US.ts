...
export default {
  ...
  browserCompatibility: {
    unsupported: {
      ...
      description:
        'You are using {browser} {version}, which does not support some features of this system.',
    ...
    oldVersion: {
      message:
        'Your {browser} {version} is outdated. Please upgrade to the latest version for a better experience.',
      dismiss: 'Dismiss',
    },
  },

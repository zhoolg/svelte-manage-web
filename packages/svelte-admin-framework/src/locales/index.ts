...
export function initI18n(
  userLocales: { 'zh-CN'?: Messages; 'en-US'?: Messages } = {}
): I18nInstance {
  // 合并框架翻译和业务翻译
  const messages: Record<Locale, Messages> = {
    'zh-CN': deepMerge(frameworkZhCN as Messages, userLocales['zh-CN'] || {}),
    'en-US': deepMerge(frameworkEnUS as Messages, userLocales['en-US'] || {}),
  };
